  ...
  return (
    <header className="dheader">
      <div className="dheader__inner">
        <Link to="/" className="dheader__logo" aria-label="StylePin home">
          StylePin
        </Link>

        <div className="dheader__search">
          <svg className="dheader__search-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <div className="dheader__actions">
          ...
          <button type="button" className="dheader__action-btn" aria-label="Settings">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <button type="button" className="dheader__avatar" aria-label="Profile">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
